...
public class GlobalArea {
    ...
    public void initComponents(String dataInput) {
        try {
        	...
        	mylib.console(1,"Error initComponent ("+e.getMessage()+")");
    ...
    public void fillLstSolrServers() throws Exception {
    	try {
	        lstSolrServers.add("hwk23:2181/solr");
	        lstSolrServers.add("hwk24:2181/solr");
	        lstSolrServers.add("hwk25:2181/solr");
