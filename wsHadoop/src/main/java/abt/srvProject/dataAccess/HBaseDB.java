...
public class HBaseDB {
	...
	public void putRow(Map<String, List<RowModel>> mapRows) throws Exception {
		try {
			...
			mylib.console("Se copiaran: "+mapRows.size()+ " filas");
	...
	public HashMap<String, HashMap<String,String>> getRows(Map<String,String> mapKey, String[] family) throws Exception {
		try {
	...
	public HashMap<String, HashMap<String,String>> getRow(String key, String[] family) throws Exception {
		try {
			Connection conn = ConnectionFactory.createConnection(hcfg);
