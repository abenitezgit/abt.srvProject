...
public class DataEcoOper {
	...
	public DataEcoOper (String fIni, String fFin, String forg, String fsuborg) {
		this.fecIni = fIni;
		this.fecFin = fFin;
		this.org = forg;
		this.suborg = fsuborg;
		...
		try {
			...
			for (int i=1; i<=numCols; i++) {
				...
				case "TENANT_DBID":
					...
					break;
				case "CUSTOM_CHAR09":
					rm.setColumn("custom9");
					rm.setFamily("f2");
					rm.setValue(rs.getString("CUSTOM_CHAR09"));
					break;
				case "CUSTOM_CHAR10":
					rm.setColumn("custom10");
					rm.setFamily("f2");
					rm.setValue(rs.getString("CUSTOM_CHAR10"));
					break;
				}
